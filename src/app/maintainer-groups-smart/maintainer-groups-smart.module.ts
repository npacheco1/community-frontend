...
const routes: Routes = [
  {
    path: '',
    data: {
      title: 'Group-Smart-table',
      urls: [
        { title: 'Tabla dinamica', url: '/maintainer-groups-smart' },
        { title: 'Groups Smart' }
      ]
    },
    component: MaintainerGroupsSmartComponent
  }
];
...
export class MaintainerGroupsSmartModule { }
