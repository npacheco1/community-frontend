    ...
    columns: {
      ...
      zone_id: {
        ...
        editor: {
            type: 'list',
            config: {
              list: [{ value: '1', title: 'ZONA A' }, { value: '2', title: 'ZONA B' }, { value: '3', title: 'ZONA D' }]
            }
          }
      },
      zone: {
      ...
      tygr_id: {
        title: 'Tipo de terreno ID',
        filter: true,
        editor: {
            type: 'list',
            config: {
              list: [{ value: '1', title: 'Casa' }, { value: '2', title: 'Cancha futbol' }, { value: '3', title: 'Cancha de voley' }]
            }
          }
      },
      type_ground: {
